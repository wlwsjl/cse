...
typedef Eigen::Matrix<flt,9,1> vec9;
typedef Eigen::Matrix<flt,6,1> vec6;
...
typedef Eigen::Matrix<flt,12,12> mat12;
...
Eigen::Matrix<double, 3, 3> Jr_so3(Eigen::Matrix<double, 3, 1> w);
